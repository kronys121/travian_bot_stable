...
Откройте http://localhost:8000. Отсюда можно добавить аккаунт, включить нужные функции, запустить и остановить бота, посмотреть логи и статистику. Каждый аккаунт запускается своим процессом.
